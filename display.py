...
class Display:
    ...
    def __init__(self, image_width: int, image_height: int):
        ...
        self.frame.frame_image_left = self.canvas.create_image((image_width/2, image_height/2),
                                                               image=self.displayable_image_left)
        self.frame.frame_image_right = self.canvas.create_image((image_width/2, image_height/2),
                                                                image=self.displayable_image_right)
    ...
    def change_image_left(self, new_image: Image):
        self.displayable_image_left = ImageTk.PhotoImage(new_image)
        self.image_left = new_image
        self.frame.frame_image_left = self.canvas.create_image((self.image_width / 2, self.image_height / 2),
                                                               image=self.displayable_image_left)
    ...
    def change_image_right(self, new_image: Image):
        self.displayable_image_right = ImageTk.PhotoImage(new_image)
        self.image_right = new_image
        self.frame.frame_image_right = self.canvas.create_image((self.image_width / 2, self.image_height / 2),
                                                                image=self.displayable_image_right)
